...
export const projects: Project[] = [
  {
    ...
    title: 'ChainedChat',
    slug: 'chainedchat',
    shortSummary: 'Full-stack AI chat application built and shipped in 2 weeks with real-time conversations and AI model chaining.',
    category: 'ai',
    duration: '2 weeks',
  ...
  },
  {
    ...
    shortSummary: 'Viral gamified quiz that went viral across NYU campus, built in 4 hours with shareable results.',
    category: 'product',
    duration: '4 hours',
    role: 'Solo Developer',
  ...
  },
  {
    ...
    title: 'HabitTracks',
    slug: 'habitracks',
    shortSummary: 'Music habit tracker for Burna Boy\'s "Our Bad Habit" campaign at Atlantic Records.',
    category: 'music',
    duration: '3 weeks',
    role: 'Full-stack Developer',
  ...
  },
  {
    ...
    shortSummary: 'Real-time RSS feed scraper with intelligent content aggregation and filtering.',
    category: 'product',
    duration: '4 weeks',
  ...
  },
  {
    ...
    title: 'Quantercise',
    slug: 'quantercise',
    shortSummary: 'Quantitative finance exercise platform with real-time market data integration.',
    category: 'quant',
    duration: '4 weeks',
    role: 'Full-stack Developer',
  ...
  },
  {
    ...
    slug: 'quant-platform',
    shortSummary: 'Full-stack member portal for 300-member intercollegiate quantitative finance club.',
    category: 'quant',
    duration: '1 week',
    role: 'Full-stack Developer',
  ...
  },
  {
    ...
    slug: 'ig-tracker',
    shortSummary: 'A&R project tracking 2,500 Instagram accounts for music industry talent discovery.',
    category: 'music',
    duration: '4 days',
    role: 'Data Engineer',
