...
export default function IntakeForm() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setError('Something went wrong. Please try again or email me directly at ani@anipotts.com')
    } finally {
  ...
  if (isSuccess) {
    return (
      <div className="max-w-2xl mx-auto text-center space-y-6 py-12">
        ...
        <h3 className="text-2xl font-serif font-bold text-foreground">Thanks for reaching out!</h3>
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-2xl mx-auto space-y-6">
      ...
      <p className="text-sm text-muted-foreground text-center">
        ...
        <a href="mailto:ani@anipotts.com" className="text-accent hover:text-accent/80 transition-colors">
          ani@anipotts.com
        </a>
      </p>
    </form>
